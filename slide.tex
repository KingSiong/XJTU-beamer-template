...
\usebackgroundtemplate{
    \begin{tikzpicture}[overlay,remember picture]
        % Background picture
        \node[at=(current page.center),anchor=center,inner sep=0pt,outer sep=0pt, fill opacity=0.36] {
            \includegraphics[keepaspectratio,height=0.5\paperheight]{style/xjtu_motto_origin.png}};
    \end{tikzpicture}
}
\begin{frame}
    % \begin{center}
